package com.riyanpriyadi.moeslimpro.JadwalSholat;
...
public class JadwalSholatActivity extends AppCompatActivity {
    ...
    private void loadKota(){
        try {
            String api = "/kota";
            CAT_JadwalSholat task = new CAT_JadwalSholat(this, api, new CAT_JadwalSholat.OnPostExecuteListener() {
                @Override
    ...
    private void loadJadwal(int id){
        try {
            ...
            CAT_JadwalSholat task = new CAT_JadwalSholat(this, api_url, new CAT_JadwalSholat.OnPostExecuteListener() {
                @Override
                public void onPostExecute(String result) {

...
public class CAT_JadwalSholat extends AsyncTask<Void, Void, String> {
    ...
    public CAT_JadwalSholat(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){

package com.riyanpriyadi.moeslimpro.ProdukHalal;
...
public class CAT_ProdukHalal extends AsyncTask<Void, Void, String> {
    ...
    public CAT_ProdukHalal(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
